...
public class BtrResourceIntTest {
    ...
    private static final Integer DEFAULT_ASSIGNED_TO = 1;
    private static final Integer UPDATED_ASSIGNED_TO = 2;

    private static final Integer DEFAULT_ASSIGNED_FROM = 1;
    private static final Integer UPDATED_ASSIGNED_FROM = 2;
    ...
    public void initTest() {
        btr = new Btr();
        btr.setId_user(DEFAULT_ID_USER);
        btr.setStatus(DEFAULT_STATUS);
        btr.setStart_date(DEFAULT_START_DATE);
        btr.setEnd_date(DEFAULT_END_DATE);
        btr.setAssigned_to(DEFAULT_ASSIGNED_TO);
        btr.setAssigned_from(DEFAULT_ASSIGNED_FROM);
    ...
    public void createBtr() throws Exception {
        ...
        assertThat(testBtr.getId_user()).isEqualTo(DEFAULT_ID_USER);
        ...
        assertThat(testBtr.getAssigned_to()).isEqualTo(DEFAULT_ASSIGNED_TO);
        assertThat(testBtr.getAssigned_from()).isEqualTo(DEFAULT_ASSIGNED_FROM);
    ...
    @Test
    @Transactional
    public void checkId_userIsRequired() throws Exception {
    ...
    public void getAllBtrs() throws Exception {
        ...
        restBtrMockMvc.perform(get("/api/btrs?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].id_user").value(hasItem(DEFAULT_ID_USER)))
                ...
                .andExpect(jsonPath("$.[*].assigned_to").value(hasItem(DEFAULT_ASSIGNED_TO)))
                .andExpect(jsonPath("$.[*].assigned_from").value(hasItem(DEFAULT_ASSIGNED_FROM)))
    ...
    public void getBtr() throws Exception {
        ...
        restBtrMockMvc.perform(get("/api/btrs/{id}", btr.getId()))
            ...
            .andExpect(jsonPath("$.id_user").value(DEFAULT_ID_USER))
            ...
            .andExpect(jsonPath("$.assigned_to").value(DEFAULT_ASSIGNED_TO))
            .andExpect(jsonPath("$.assigned_from").value(DEFAULT_ASSIGNED_FROM))
    ...
    public void updateBtr() throws Exception {
        ...
        // Update the btr
        btr.setId_user(UPDATED_ID_USER);
        btr.setStatus(UPDATED_STATUS);
        btr.setStart_date(UPDATED_START_DATE);
        btr.setEnd_date(UPDATED_END_DATE);
        btr.setAssigned_to(UPDATED_ASSIGNED_TO);
        btr.setAssigned_from(UPDATED_ASSIGNED_FROM);
        ...
        Btr testBtr = btrs.get(btrs.size() - 1);
        assertThat(testBtr.getId_user()).isEqualTo(UPDATED_ID_USER);
        ...
        assertThat(testBtr.getAssigned_to()).isEqualTo(UPDATED_ASSIGNED_TO);
        assertThat(testBtr.getAssigned_from()).isEqualTo(UPDATED_ASSIGNED_FROM);
